...
Userback.access_token = '9670|60837|Gw5qPv96AfBgPO1y8PxUO0QkGEDhs01IdajajYQcjg3QabbjNp';
(function(d) {
...
window._wpemojiSettings = {
    ...
    "svgExt": ".svg",
    "source": {
        "concatemoji": "https:\/\/www.united.com.bd\/wp-includes\/js\/wp-emoji-release.min.js?ver=7559c08869f357cc192eb3f196fe7955"
    }
};
...
(()=>{
    ...
    const e = e=>Math.abs(parseInt(e, 10))
      ...
      , r = e=>{
        ...
        return n.reduceRight(((e,t)=>a=>t(a, e)), (e=>{
            let r, n, {url: o, path: c, endpoint: i, headers: s, body: l, data: d, ...u} = e;
            "string" == typeof i && (r = a.replace(/^\/|\/$/g, ""),
            n = i.replace(/^\//, ""),
            c = n ? r + "/" + n : r),
    ...
    function o(e) {
        ...
        if (void 0 === d)
            return;
        if (null === (r = s.target) || void 0 === r || !r.closest(".wpcf7-form-control-wrap[data-name]"))
            return;
    ...
    function s(e) {
        ...
        r({
            ...
            i.apiResponse = r,
            ["invalid", "unaccepted", "spam", "aborted"].includes(n) ? a(e, n, i) : ["sent", "failed"].includes(n) && a(e, `mail${n}`, i),
            a(e, "submit", i),
            r
        }
        )).then((t=>{
